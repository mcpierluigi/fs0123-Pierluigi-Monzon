...
function deleteOnte(Stringa, booleano){
  return booleano ? Stringa.slice(1) : Stringa.slice(0, Stringa.length - 1);
}
...
console.log(isThisAnEmail('pierlui-gi@hotmail.com'));
...
function deleteProp(Ogetto, Stringa){
  delete Ogetto[Stringa];
  return Ogetto;
}
...
function newestMovie(movies){
  return movies.reduce((a,b) => a.Year > b.Year? a.Title : b.Title);
}
